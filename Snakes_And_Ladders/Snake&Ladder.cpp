...
tuple<int, int, int, char, char, char> 
...
tuple<int, int, int, int> winGift(string a, string b, string c, int p1, int p2, int p3){
	int gift;
	char t=0;
...
void check_location(int& p1, int& p2, int& p3, int& p4, int s1, int s2, int s3, int s4, int s5, int l1, int l2, int l3, int l4, int l5)
{
	...
	if (p1 == s1) {
		...
		system("Color 4");
		Sleep(1000);
		cout << "Player(P) got into Snake!! at " << t << " you are moved to place" << p1 << endl;
		flag = 1;
	}
	else if (p1 == s2) {
		t = p1;
	...
	if (p2 == s1) {
		...
		system("Color 4");
		Sleep(1000);
		cout << "Player(P) got into Snake!! at " << t << " you are moved to place" << p2 << endl;
		flag = 1;
	}
	else if (p2 == s2) {
		t = p2;
	...
	if (p3 == s1) {
		...
		system("Color 4");
		Sleep(1000);
		cout << "Player(P) got into Snake!! at " << t << " you are moved to place" << p3 << endl;
		flag = 1;
	}
	else if (p3 == s2) {
		t = p3;
	...
	if (p4 == s1) {
		...
		system("Color 4");
		Sleep(1000);
		cout << "Player(P) got into Snake!! at " << t << " you are moved to place" << p4 << endl;
		flag = 1;
	}
	else if (p4 == s2) {
		t = p4;
	...
	if (p1 == l1) {
		...
		system("Color 2");
		Sleep(1000);
		cout << "Player(P) got into LADDER!! at " << t << " you are moved to place" << p1 << endl;
		flag = 1;
	}
	else if (p1 == l2) {
		t = p1;
	...
	if (p2 == l1) {
		...
		system("Color 2");
		Sleep(1000);
		cout << "Player(P) got into LADDER!! at " << t << " you are moved to place" << p2 << endl;
		flag = 1;
	}
	else if (p2 == l2) {
		t = p2;
	...
	if (p3 == l1) {
		...
		system("Color 2");
		Sleep(1000);
		cout << "Player(P) got into LADDER!! at " << t << " you are moved to place" << p3 << endl;
		flag = 1;
	}
	else if (p3 == l2) {
		t = p3;
	...
	if (p4 == l1) {
		...
		system("Color 2");
		Sleep(1000);
		cout << "Player(P) got into LADDER!! at " << t << " you are moved to place" << p4 << endl;
		flag = 1;
	}
	else if (p4 == l2) {
		t = p4;
